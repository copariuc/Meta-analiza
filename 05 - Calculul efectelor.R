...
g.5 <- esc_beta(beta = .356, sdy = 0.35 * sqrt(139), grp1n = 139/2, grp2n = 139/2, 
                    es.type = "g", study = "Gylfason et al. (2021)")
g.5.m.1 <- "Trolling"; g.5.m.2 <- "Narcissism"; g.5.rxx <- .67; g.5.ryy <- .63

g.6 <- esc_beta(beta = .242, sdy = 0.36 * sqrt(139), grp1n = 139/2, grp2n = 139/2, 
                    es.type = "g", study = "Gylfason et al. (2021)")
g.6.m.1 <- "Trolling"; g.6.m.2 <- "Machiavellianism"; g.6.rxx <- .67; g.6.ryy <- .80

g.7 <- esc_beta(beta = .063, sdy = 0.33 * sqrt(139), grp1n = 139/2, grp2n = 139/2, 
                    es.type = "g", study = "Gylfason et al. (2021)")
g.7.m.1 <- "Trolling"; g.7.m.2 <- "Psychopathy"; g.7.rxx <- .67; g.7.ryy <- .74

g.8 <- esc_beta(beta = -.110, sdy = 0.25 * sqrt(139), grp1n = 139/2, grp2n = 139/2, 
                    es.type = "g", study = "Gylfason et al. (2021)")
...
year <- tabel.surse[which(tabel.surse$label == "ref_159"),]$year
...
year <- tabel.surse[which(tabel.surse$label == "ref_195"),]$year

## 17. Studiul ref_216 - CODARE ####
year <- tabel.surse[which(tabel.surse$label == "ref_216"),]$year

## 18. Studiul ref_221 - CODARE ####
year <- tabel.surse[which(tabel.surse$label == "ref_221"),]$year

## 19. Studiul ref_224 - CODARE ####
year <- tabel.surse[which(tabel.surse$label == "ref_224"),]$year
